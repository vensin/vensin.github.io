...
for (var i = article.length - 1; i >= 0; i--) {//跳转到文章页面
...
var wapper = document.getElementsByClassName("wapper")[0];
 ...
 toLoad.onclick = function(){
	...
	document.getElementsByClassName("no-load-tip")[0].style.display="none";
}
noLoad.onclick = function (argument) {
	welcomePage.style.display="none";
	welcomeBg.style.display="none";
	wapper.style.display="block";
	document.getElementsByClassName("load-text")[0].style.display="none";
}
...
var articleList = document.getElementsByClassName("article-title");
